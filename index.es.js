...
var DefaultEventRootComponent = /*#__PURE__*/ React.memo(
  /*#__PURE__*/
  React.forwardRef(function DefaultEventRootComponent(
    ...
    return /*#__PURE__*/ React.createElement(
      'div',
      _extends({ ref: ref, 'aria-disabled': disabled }, props),
    );
  }),
);
...
function useClickAndDrag(ref, isDisabled) {
  ...
  useEffect(
    function() {
      ...
      var touchStartWithDelay$ = touchStart$.pipe(
        mergeMap(function(start) {
          return of(start).pipe(delay(300), takeUntil(touchMove$), prevent);
        }),
      );
 ...
 */
function useMousetrap(handlerKey, handlerCallback, elementOrElementRef) {
...
var cellToDate = function cellToDate(_ref) {
  ...
  return addMinutes(addDays(originDate, startX), toMin(startY));
};
  ...
  return function(_ref2) {
    ...
    var result = range(startX, endX + 1)
      ...
      .sort(function(range1, range2) {
        return compareAsc(range1[0], range2[0]);
      });
...
function getEarliestTimeRange(ranges) {
  return _toConsumableArray(ranges).sort(function(_ref, _ref2) {
    var _ref3 = _slicedToArray(_ref, 1),
      startA = _ref3[0];
    var _ref4 = _slicedToArray(_ref2, 1),
      startB = _ref4[0];
    return compareAsc(setDay(startA, 0), setDay(startB, 0));
  })[0];
}
...
var dropSame = function dropSame(dates, template) {
  ...
  var _dates$map = dates.map(function(date) {
      return format(date, template, { locale: locale });
    }),
...
var formatHour = function formatHour(date, locale) {
...
var getFormattedComponentsForDateRange = function getFormattedComponentsForDateRange(
  _ref,
) {
  var dateRange = _ref.dateRange,
    locale = _ref.locale,
    template = _ref.template,
    template2 = _ref.template2,
    _ref$includeDayIfSame = _ref.includeDayIfSame,
    includeDayIfSame =
      _ref$includeDayIfSame === void 0 ? true : _ref$includeDayIfSame;
  var start = dateRange[0];
  var end = dateRange[dateRange.length - 1];

  if (isSameDay(start, end) && !template) {
    var _dropSame = dropSame(dateRange, 'a', true, locale),
      _dropSame2 = _slicedToArray(_dropSame, 2),
      firstM = _dropSame2[0],
      secondM = _dropSame2[1];
    var day = includeDayIfSame
      ? ''.concat(format(start, 'ddd', { locale: locale }), ' ')
      : '';
    return [
      ''
        .concat(day)
        ...
        .concat(firstM),
      ''.concat(formatHour(end, { locale: locale })).concat(secondM),
    ];
  }
...
var EventContent = /*#__PURE__*/ React.memo(function EventContent(_ref) {
  var width = _ref.width,
    ...
    isEnd = _ref.isEnd;
  var _useContext = useContext(SchedulerContext),
    locale = _useContext.locale;
  var _getFormattedComponen = getFormattedComponentsForDateRange({
      dateRange: dateRange,
      locale: locale,
      includeDayIfSame: false,
    }),
    _getFormattedComponen2 = _slicedToArray(_getFormattedComponen, 2),
    start = _getFormattedComponen2[0],
    end = _getFormattedComponen2[1];
...
var RangeBox = /*#__PURE__*/ React.memo(function RangeBox(_ref2) {
  ...
  var classes = _ref2.classes,
    ...
    getIsActive = _ref2.getIsActive,
    _ref2$eventContentCom = _ref2.eventContentComponent,
    EventContentComponent =
      _ref2$eventContentCom === void 0 ? EventContent : _ref2$eventContentCom,
    _ref2$eventRootCompon = _ref2.eventRootComponent,
    EventRootComponent =
      _ref2$eventRootCompon === void 0
        ? DefaultEventRootComponent
        : _ref2$eventRootCompon,
  ...
  var isActive = useMemo(
    function() {
      return getIsActive({ cellIndex: cellIndex, rangeIndex: rangeIndex });
    },
  ...
  var handleDrag = useCallback(
    function(event, _ref3) {
      ...
      var newRect = _objectSpread2({}, rect);
  ...
  var handleResize = useCallback(
    function(event, direction, _ref, delta) {
      ...
      var newRect = _objectSpread2(_objectSpread2({}, originalRect), newSize);
      ...
      EventRootComponent,
      {
        ...
        className: classcat([
          ...
          _defineProperty(
            ...
            !disabled && moveAxis !== 'none',
          ),
          _defineProperty(_ref4, classes['is-disabled'], disabled),
          _ref4),
        ]),
...
var Schedule = /*#__PURE__*/ React.memo(function Schedule(_ref) {
  var classes = _ref.classes,
    ...
    moveAxis = _ref.moveAxis,
    cellInfoToDateRange = _ref.cellInfoToDateRange,
    dateRangeToCells = _ref.dateRangeToCells,
    onActiveChange = _ref.onActiveChange,
    eventContentComponent = _ref.eventContentComponent,
    eventRootComponent = _ref.eventRootComponent,
    onClick = _ref.onClick,
    getIsActive = _ref.getIsActive,
    disabled = _ref.disabled;
  return /*#__PURE__*/ React.createElement(
    'div',
    ...
    ranges.map(function(dateRange, rangeIndex) {
      return /*#__PURE__*/ React.createElement(
        ...
        dateRangeToCells(dateRange).map(function(cell, cellIndex, cellArray) {
          return /*#__PURE__*/ React.createElement(RangeBox, {
            classes: classes,
...
var TimeGridScheduler = /*#__PURE__*/ React.memo(function TimeGridScheduler(
  _ref,
) {
  var _ref$verticalPrecisio = _ref.verticalPrecision,
    ...
    _ref$cellClickPrecisi = _ref.cellClickPrecision,
    cellClickPrecision =
      _ref$cellClickPrecisi === void 0
        ? visualGridVerticalPrecision
        : _ref$cellClickPrecisi,
    style = _ref.style,
    schedule = _ref.schedule,
    _ref$originDate = _ref.originDate,
    _originDate = _ref$originDate === void 0 ? new Date() : _ref$originDate,
    _ref$defaultHours = _ref.defaultHours,
    defaultHours = _ref$defaultHours === void 0 ? [9, 15] : _ref$defaultHours,
    classes = _ref.classes,
    className = _ref.className,
    onChange = _ref.onChange,
  ...
  var _useClickAndDrag = useClickAndDrag(parent, disabled),
  ...
  var _useState3 = useState([0, 0]),
    ...
    totalHeight = _useState4$[0],
    totalWidth = _useState4$[1],
  ...
  var _useState5 = useState([null, null]),
    ...
    activeRangeIndex = _useState6$[0],
    activeCellIndex = _useState6$[1],
  ...
  var getIsActive = useCallback(
    function(_ref2) {
      var rangeIndex = _ref2.rangeIndex,
        cellIndex = _ref2.cellIndex;
  ...
  var _useState7 = useState(false),
    _useState8 = _slicedToArray(_useState7, 2),
    wasInitialScrollPerformed = _useState8[0],
    setWasInitialScrollPerformed = _useState8[1];
  ...
  useEffect(
    function performInitialScroll() {
      ...
      var rect = grid.getRectFromCell(range[0]);
      var top = rect.top,
        bottom = rect.bottom;
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    React.createElement(
      'div',
      { className: classes['grid-root'] } /*#__PURE__*/,
      React.createElement(
        'div',
        {
          'aria-hidden': true,
        ...
        React.createElement(
          'div',
          { className: classes.header } /*#__PURE__*/,
          React.createElement(
            'div',
        ...
        React.createElement(
          'div',
          { className: classes.calendar } /*#__PURE__*/,
          React.createElement(
            'div',
            { className: classes['day-column'] } /*#__PURE__*/,
            React.createElement(
                ...
                times(numVisualVerticalCells).map(function(timeIndex) {
                  return /*#__PURE__*/ React.createElement(Cell, {
                    ...
                    onClick: handleCellClick(
                      dayIndex,
                      timeIndex * (numVerticalCells / numVisualVerticalCells),
                    ),
...
var styles_module = {
  ...
  theme: 'styles-module_theme__1FIRA',
  root: 'styles-module_root__2iNXQ',
  'grid-root': 'styles-module_grid-root__2ktzS',
  ...
  'is-disabled': 'styles-module_is-disabled__2JPDR',
  ...
  'day-header-row': 'styles-module_day-header-row__27lss',
  'sticky-top': 'styles-module_sticky-top__2dSgb',
  'sticky-left': 'styles-module_sticky-left__3tNLK',
